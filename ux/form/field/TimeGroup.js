 ...
 * @author lightyear
 */
Ext.define('Ext.ux.form.field.TimeGroup', {
      extend: 'Ext.form.field.Base',
      alias: 'widget.timegroup',
      requires: ['Ext.form.field.Number'],
      // 隐藏BaseField的输入框 , hidden basefield's input
      inputType: 'hidden',
      style: 'padding:4px 0 0 0;margin-bottom:0px;margin-left:6px;',
      /**
       * @cfg {String} value
      ...
      */
      ...
      initComponent: function() {
          ...
          me.hoursSpinner = Ext.create('Ext.form.field.Number', Ext.apply({}, cfg2, {
                  itemId:'timegrouphour',
				  margin:'0 2 0 0',
				  minValue: 0,
                  maxValue: 23
              }));
