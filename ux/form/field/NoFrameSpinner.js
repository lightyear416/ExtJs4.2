 ...
 */
Ext.define('Ext.ux.form.field.NoFrameSpinner', {
    extend: 'Ext.form.field.Trigger',
    alternateClassName: 'Ext.ux.form.NoFrameSpinner',
    ...
    getSubTplMarkup: function(values) {
        ...
        return '<table id="' + me.id + '-triggerWrap" class="' + Ext.baseCSSPrefix + 'form-noframe ' + Ext.baseCSSPrefix + 'form-trigger-wrap' + childElCls + '" cellpadding="0" cellspacing="0">' +
            '<tbody>' +
