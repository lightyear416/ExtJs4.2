...
Ext.define('Ext.ux.form.field.TreePicker', {
    ...
    config: {
        ...
        * Check treepanel's width whether to match picker's width
        */
    ...
    createPicker: function() {
        var me = this;
		me.tree.shrinkWrapDock = 2;
		me.tree.floating = true;
		me.tree.minHeight = me.minPickerHeight;
		me.tree.maxHeight = me.maxPickerHeight;
		me.tree.manageHeight = false;
		me.tree.shadow = false;
		me.tree.doLayout();
    ...
    /**
     * Handles a dblclick even on a tree node
     * @private
