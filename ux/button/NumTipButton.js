/*
* @class Ext.ux.button.NumTipButton
...
Ext.define('Ext.ux.button.NumTipButton', {

    /* Begin Definitions */
    alias: 'widget.numtipbutton',
    ...
    alternateClassName: 'Ext.NumTipButton',
    /* End Definitions */
    ...
    */
    ...
    childEls: [
        'btnEl', 'btnWrap', 'btnInnerEl', 'btnIconEl', 'btnNumTipEl'
    ],
    ...
    renderTpl: [
        '<span id="{id}-btnWrap" class="{baseCls}-wrap',
            ...
            '</span>',
        '</span>',
		'<span id="{id}-btnNumTipEl" class="x-btn-tip-num" style="{numTipStyle}">{showNum}</span>',
    ...
    */
    ...
    initComponent: function () {
        ...
        */
        ...
        /**
        * @event numchange
        * Fired when the button's tip number is changed by the {@link #setNum} method.
        * @param {Ext.button.Button} this
        * @param {String} oldNum
        * @param {String} newNum
        */
        ...
        /**
        * @event shownumchange
        * Fired when the button's tip shownumber is changed by the {@link #setNum} method.
        * @param {Ext.button.Button} this
        * @param {String} oldShowNum
        * @param {String} newShowNum
        */
            'shownumchange',
    ...
    */
    getTemplateArgs: function () {
        ...
        if (typeof Num === 'number' && typeof MaxShowNum === 'number') {
            if (Num > MaxShowNum) {
                me.showNum = MaxShowNum + "+";
            } else {
                me.showNum = Num;
            }
            showNum = me.showNum;
    ...
    */
    ...
    /**
    * Sets this Button's tip number
    * @param {Number} num The button tip number
    * @return {Ext.ux.button.NumTipButton} this
    */
    setNum: function (num) {
        num = num || 0;
        var me = this,
            oldNum = me.num || 0,
			oldShowNum = me.showNum || '';

        if (num != oldNum) {
            me.num = num;
            if (num > me.maxShowNum) {
                me.showNum = me.maxShowNum + '+';
            } else {
                me.showNum = num;
            }
            if (me.showNum != oldShowNum) {

                if (me.rendered) {
                    me.btnNumTipEl.update(me.showNum || '');
                    me.setComponentCls();
                    if (Ext.isStrict && Ext.isIE8) {
                        // weird repaint issue causes it to not resize
                        me.el.repaint();
                    ...
                    me.updateLayout();
                    me.fireEvent('shownumchange', me, oldShowNum, me.showNum);
                }
            }

            me.fireEvent('numchange', me, oldNum, num);
        }
        return me;
    },
    ...
    */
    ...
    /**
    * Gets the num for this Button tip
    * @return {Number} The button tip number
    */
    getNum: function () {
        return this.num;
    },
